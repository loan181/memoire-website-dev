...
Blockly.Msg["COUNTER_GET"] = "Compteurs";
Blockly.Msg["COUNTER_GET_TOOLTIP"] = "Obtenir la valeur du compteur des fleurs (prévu pour l'affichage)";
Blockly.Msg["COUNTER_INCREASE"] = "Augmenter le compteur de la classe de la %1 %2 ème fleur la plus proche de %3 %4";
Blockly.Msg["COUNTER_INCREASE_TOOLTIP"] = "Permet de modifier la valeur du compteur correpondant à la ième fleur la plus proche";
Blockly.Msg["COUNTER_RESET"] = "Réinitialiser les compteurs";
Blockly.Msg["COUNTER_RESET_TOOLTIP"] = "Réinitialise les compteurs pour chaque fleur à zéro";
Blockly.Msg["COUNTER_RETRIEVE"] = "Récupérer la fleur avec la valeur %1 du compteur";
Blockly.Msg["COUNTER_RETRIEVE_TOOLTIP"] = "Récupérer la fleur associé à la valeur maximale/minimale du compteur";
...
Blockly.Msg["FLOWER_CREATE"] = "Créer une fleur aux coordonnées";
Blockly.Msg["FLOWER_CREATE_TOOLTIP"] = "Créer une fleur aux coordonnées (x, y) données. x et y dépendent des paramètres choisis par l'utilisateurs";
Blockly.Msg["FLOWER_GET_K_NEIGHBOURS"] = "Obtenir liste des K fleurs les plus proches de";
Blockly.Msg["FLOWER_GET_K_NEIGHBOURS_TOOLTIP"] = "Renvoie la liste de tout les noms des K fleurs les plus prochent de la fleur donnée";
Blockly.Msg["FLOWER_LIST"] = "Obtenir liste des noms de fleurs";
Blockly.Msg["FLOWER_LIST_TOOLTIP"] = "Renvoie la liste de tout les noms de fleurs disponibles";
Blockly.Msg["GET_K"] = "K";  // untranslated
Blockly.Msg["GET_K_TOOLTIP"] = "Retourne la valeur de K";
...
Blockly.Msg["RANDOM_FLOWER"] = "Obtenir un nom de fleur aléatoire";
Blockly.Msg["RANDOM_FLOWER_TOOLTIP"] = "Donne un nom de fleur aléatoire parmis les 3 disponibles";
