...
Blockly.Msg["BLOCKLY_HELP_URL_KNN"] = "https://loan181.github.io/KNN/blockly-aide";  // untranslated
...
Blockly.Msg["COUNTER_GET"] = "Counters";  // untranslated
Blockly.Msg["COUNTER_GET_TOOLTIP"] = "Return the counter associated to each flower (to be print)";  // untranslated
Blockly.Msg["COUNTER_INCREASE"] = "Increase the counter of the class of the %1 %2 th nearest flower by 1 %3";  // untranslated
Blockly.Msg["COUNTER_INCREASE_TOOLTIP"] = "Modify the value of the i-th nearest flower by a certain amount";  // untranslated
Blockly.Msg["COUNTER_RESET"] = "Reset the counters";  // untranslated
Blockly.Msg["COUNTER_RESET_TOOLTIP"] = "Reset the counters such that the counter for each flower is set to zero";  // untranslated
Blockly.Msg["COUNTER_RETRIEVE"] = "Return the flower with the %1 value of the counter";  // untranslated
Blockly.Msg["COUNTER_RETRIEVE_TOOLTIP"] = "Retrieve the flower associated to the maximum/minimum value of the counter";  // untranslated
...
Blockly.Msg["FLOWER_CREATE"] = "create a flower on coordinates";  // untranslated
Blockly.Msg["FLOWER_CREATE_TOOLTIP"] = "Create a new flower. x and y correspond to the metrics set by the user";  // untranslated
Blockly.Msg["FLOWER_GET_K_NEIGHBOURS"] = "Get list of the K nearest flower from";  // untranslated
Blockly.Msg["FLOWER_GET_K_NEIGHBOURS_TOOLTIP"] = "Return a list of string of the K nearest flowers name of the given flower";  // untranslated
Blockly.Msg["FLOWER_LIST"] = "get all flowers names list";  // untranslated
Blockly.Msg["FLOWER_LIST_TOOLTIP"] = "Return the all distinct flower names as an array of String";  // untranslated
Blockly.Msg["GET_K"] = "K";  // untranslated
Blockly.Msg["GET_K_TOOLTIP"] = "Return the value of K";  // untranslated
...
Blockly.Msg["RANDOM_FLOWER"] = "Get a random flower name";  // untranslated
Blockly.Msg["RANDOM_FLOWER_TOOLTIP"] = "Return randomly one of the three defined flower";  // untranslated
